  ...
  return (
    <div className="relative w-full min-h-screen">
      ...
      <motion.div
        ...
        style={{ originY: 0 }}
        className="fixed top-0 left-0 right-0 h-1/2 bg-zinc-950 shutter-blade gpu-accelerate z-[9999] pointer-events-none border-b border-amber-500/35 flex flex-col justify-end items-center pb-2 overflow-hidden shadow-[0_10px_40px_rgba(0,0,0,0.95)]"
      >
      ...
      <motion.div
        ...
        transition={{ duration: 0.5, ease: shutterEase }}
        style={{ originY: 1 }}
        className="fixed bottom-0 left-0 right-0 h-1/2 bg-zinc-950 shutter-blade gpu-accelerate z-[9999] pointer-events-none border-t border-amber-500/35 flex flex-col justify-start items-center pt-2 overflow-hidden shadow-[0_-10px_40px_rgba(0,0,0,0.95)]"
      >
