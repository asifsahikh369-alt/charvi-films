    ...
    <div className="bg-zinc-900/40 border border-white/10 rounded-3xl p-6 sm:p-10 font-mono space-y-8 relative overflow-hidden">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/10 pb-6">
        <div className="space-y-1">
          <div className="flex items-center gap-2 text-xs text-indigo-400 uppercase tracking-widest">
        ...
        <div className="flex items-center gap-2 text-xs text-emerald-400 bg-emerald-950/40 border border-emerald-500/30 px-3 py-1.5 rounded-full w-fit">
      ...
      <div className="flex items-center gap-2 overflow-x-auto pb-2 scrollbar-none text-xs">
        {CATEGORIES.map((cat) => (
          <button
            ...
            className={`px-4 py-2 rounded-xl border text-xs tracking-wider uppercase transition-all duration-300 shrink-0 ${
            ...
            {GEAR_DATA[activeCategory].map((item) => (
              ...
              >
                <div className="space-y-1.5">
                  <span className="text-xs text-indigo-400 uppercase tracking-widest block font-bold">
                    [HARDWARE NODE]
                  </span>
